...
where
	...
	<R as frame_system::Config>::AccountId: From<primitives::active_api::AccountId>,
	<R as frame_system::Config>::AccountId: Into<primitives::active_api::AccountId>,
...
mod tests {
	...
	use primitives::active_api::AccountId;
	use sp_core::H256;
	use sp_runtime::{
		testing::Header,
