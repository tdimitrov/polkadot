...
use primitives::active_api::{BlockNumber, ValidatorId, PARACHAIN_KEY_TYPE_ID};
...
struct EventValidator {
	events:
		Vec<frame_system::EventRecord<<Test as frame_system::Config>::Event, primitives::active_api::Hash>>,
}
...
fn verify_upgrade_go_ahead_signal_is_externally_accessible() {
	use primitives::active_api::well_known_keys;
