...
pub mod v1 {
	use super::*;
	use primitives::active_api::{Balance, SessionIndex};
...
mod tests {
	...
	fn v1_deserialized_from_actual_data() {
		...
		let v1 = v1::HostConfiguration::<primitives::active_api::BlockNumber>::decode(&mut &raw_config[..])
			.unwrap();
	...
	fn test_migrate_to_v2() {
		...
		// fine.
		let v1 = v1::HostConfiguration::<primitives::active_api::BlockNumber> {
		...
		let pending_configs_v1 = vec![
			(
				1,
				v1::HostConfiguration::<primitives::active_api::BlockNumber> {
		...
		fn assert_correct_translation(
			v1: v1::HostConfiguration<primitives::active_api::BlockNumber>,
			v2: configuration::HostConfiguration<primitives::active_api::BlockNumber>
		) {
