...
use bitvec::bitvec;
use polkadot_primitives::active_api::{OccupiedCore, ScheduledCore};
...
mod select_availability_bitfields {
	...
	use polkadot_primitives::active_api::{ScheduledCore, SigningContext, ValidatorId, ValidatorIndex};
