...
use polkadot_primitives::active_api::{AuthorityDiscoveryId, CandidateHash, Hash, ValidatorIndex};
...
mod tests {
	...
	use polkadot_primitives::active_api::{CandidateHash, Hash, ValidatorIndex};
